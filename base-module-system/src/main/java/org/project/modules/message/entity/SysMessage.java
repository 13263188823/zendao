...
import org.project.common.aspect.annotation.Dict;
import org.project.common.system.base.entity.JeecgEntity;
...
public class SysMessage extends JeecgEntity {
    ...
    public void setEsType(String msgType) {
    }

	public void setEsTitle(String title) {
	}

	public void setEsContent(String content) {
	}

	public void setEsParam(String toJSONString) {
	}

	public void setEsSendTime(Date date) {
	}

	public void setEsSendStatus(String code) {
	}

	public void setEsSendNum(int i) {
	}
}
